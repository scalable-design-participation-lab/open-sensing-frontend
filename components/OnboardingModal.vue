<template>
  <UCard
    v-if="isVisible"
    class="onboarding-card max-w-[90vw] w-[500px] max-h-[90vh] overflow-y-auto z-50 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 rounded-xl shadow-xl dark:bg-slate-950"
  >
    <template #header>
    ...
    <div class="space-y-8 px-6">
      ...
      <div class="space-y-3 leading-tight">
        <div class="flex items-start space-x-3">
          ...
          />
          <p>
            Досліджуйте мапу та діліться думкою про місця навколо річки Тяжилівка 
          </p>
        </div>
        ...
        <div class="flex items-start space-x-3">
          ...
          />
          <p>
            Беріть участь в обговореннях з іншими користувачами 
          </p>
        </div>
        ...
        <div class="flex items-start space-x-3">
          ...
          />
          <p>
            Додавайте коментарі, щоб поділитися спогадами та ідеями для покращення річки
          </p>
        </div>
      </div>
    </div>
